...
const SwapTitle = t`Buy, sell & trade Ethereum and other top tokens on Tacitus Swap`

export const routes: RouteDefinition[] = [
  createRouteDefinition({
    path: '/',
    getTitle: () => t`Tacitus Swap | Trade crypto safely on the top DeFi exchange`,
    getElement: (args) => {
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Buy & sell on Tacitus Swap`,
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Explore pools on Tacitus Swap`,
    getElement: () => (
  ...
  createRouteDefinition({
    path: '/vote/*',
    getTitle: () => t`Vote on governance proposals on Tacitus Swap`,
    getElement: () => (
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Create a new governance proposal on Tacitus Swap`,
    getElement: () => <Navigate to="/vote/create-proposal" replace />,
  }),
  createRouteDefinition({
    path: '/send',
    getElement: () => <Swap />,
    getTitle: () => t`Send tokens on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/limits',
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Explore top liquidity pools (v2) on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/pool/v2',
    getElement: () => <PoolV2 />,
    getTitle: () => t`Provide liquidity to pools (v2) on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/pool',
    getElement: () => <Pool />,
    getTitle: () => t`Manage & provide pool liquidity on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/pool/:tokenId',
    getElement: () => <PositionPage />,
    getTitle: () => t`Manage pool liquidity on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/pools/v2/find',
    getElement: () => <PoolFinder />,
  ...
  createRouteDefinition({
    path: '/pools/v2',
    getElement: () => <PoolV2 />,
    getTitle: () => t`Manage & provide v2 pool liquidity on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/pools',
    getElement: () => <Pool />,
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Provide liquidity to pools on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/remove/v2/:currencyIdA/:currencyIdB',
    getElement: () => <RemoveLiquidity />,
    getTitle: () => t`Manage v2 pool liquidity on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/remove/:tokenId',
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Migrate v2 pool liquidity to Tacitus Swap v3`,
  }),
  createRouteDefinition({
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Trade NFTs across OpenSea & other top marketplaces on Tacitus Swap`,
  }),
  createRouteDefinition({
    ...
    enabled: (args) => !args.shouldDisableNFTRoutes,
    getTitle: () => t`Explore NFTs on Tacitus Swap`,
  }),
  createRouteDefinition({
    path: '/nfts/profile',
    getElement: () => (
